...
```{r, eval = FALSE}
#load package for reading csv file
library("dplyr")

# Read in your data with the appropriate function
data <- read.csv("~/Projects/sexual_assault_college/BJS_SA_data/rsavcaf9513t04.csv")
...
```
My data is ok, but it could be more tidy. Right now the variables do not have descriptive names they are just labeled with letters and numbers. 
